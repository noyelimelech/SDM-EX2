...
public class afterOrderStoreWeBuyFromGuiController {
    ...
    public void updateLabels(OneStoreOrder oneStoreOrder) {
        ...
        locationLabel.setText(String.format("x=%d y=%d",oneStoreOrder.getStoreOrderMadeFrom().getLocation().getXLocation(), oneStoreOrder.getStoreOrderMadeFrom().getLocation().getYLocation()));
